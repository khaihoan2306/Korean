...
const $containerBase: ViewStyle = {
  ...
  padding: spacing.xs,
  borderWidth: 1,
  shadowColor: colors.palette.dark800,
...
const $containerPresets = {
  default: [
    $containerBase,
    {
      backgroundColor: colors.palette.dark100,
      borderColor: colors.palette.dark300,
    },
  ] as StyleProp<ViewStyle>,

  reversed: [
    $containerBase,
    { backgroundColor: colors.palette.dark800, borderColor: colors.palette.dark500 },
  ] as StyleProp<ViewStyle>,
}

const $headingPresets: Record<Presets, TextStyle> = {
  default: {},
  reversed: { color: colors.palette.dark100 },
}
